...
enum PayloadStructureType { assetImageInputChatCompletion, textInputChatCompletion, networkImageInputChatCompletion}
...
Map<String, dynamic> payloadStructureTypeSwitch(
  ...
  switch (payloadStructureType) {
    // Local image + text prompt input (GPT-4)
    case PayloadStructureType.assetImageInputChatCompletion:
      return {
  ...
  // Network image + text prompt input (GPT-4)
    case PayloadStructureType.networkImageInputChatCompletion:
      return {
        "model": modelTypeSwitch(payloadModel.model),
        "messages": [
          {
